...
if pmi.isController:
    class DomainDecomposition(Storage):
        pmiproxydefs = dict(
          ...
          pmicall = ['getCellGrid', 'getNodeGrid', 'cellAdjust','resetParticlesHangoverCounters','resetParticlesCommCellsCounters'],
          pmiinvoke = ['getCounters','getCommCellsTotalParticles']
        )
